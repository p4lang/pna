...
/*
    ...
    // Note that the name 'lookup_value' is a default action parameter
    // name generated by the P4 compiler in this case, because the
    // value type of emap1 is bit<16>, with no name.
    action lookup (bit<16> lookup_value) {
        // body of action is irrelevant for control plane API generation
    }
    table emap1 {
        key = {
...
/*
    ...
    // The action parameters of action 'lookup' correspond to the
    // fields of struct 'emap2_val', "exploded" out in order to use
    // the types and names of the member fields of the struct.
    action lookup (bit<4> val1, bit<12> val2) {
        // body of action is irrelevant for control plane API generation
    }
    table emap2 {
        key = {
...
/*
    ...
    // Note that the name 'lookup_value' is a default action parameter
    // name generated by the P4 compiler in this case, because the
    // value type of tmap1 is bit<16>, with no name.
    action lookup (bit<16> lookup_value) {
        // body of action is irrelevant for control plane API generation
    }
    table tmap1 {
...
/*
    ...
    // The action parameters of action 'lookup' correspond to the
    // fields of struct 'tmap2_val', "exploded" out in order to use
    // the types and names of the member fields of the struct.
    action lookup (bit<8> v1, bit<10> v2) {
        // body of action is irrelevant for control plane API generation
    }
    table tmap2 {
        key = {
